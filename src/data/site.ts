...
export const orderFormUrl = "https://naver.me/FLEGVR8D";
...
export const heroEyebrow = "농장에서 식탁까지 신선하게 찾아갑니다.";
...
export const peachFeatureItems = [
  {
    title: "딱복에서 물복까지",
    description: "홍백은 쉽게 무르지 않아 두바이로 수출도 하는 품종입니다. 수확 직후에는 아삭하며 후숙되면 쫀득해지는 식감을 즐길 수 있습니다.",
  },
  {
    title: "평균 당도 12.7브릭스",
  ...
  {
    title: "당일 수확 당일 발송",
    description: "최근 영천지역 날씨가 더워 복숭아 성장이 아주 좋습니다. 비가 오거나 날씨에 이상이 없으면 작업하여 순차배송 해드립니다.",
  },
  {
    title: "언제 받아볼 수 있나요?",
    description: "작업 일정에 따라 순차배송 드립니다. 수확 일정은 날씨에 따라 변경될 수 있습니다.",
  },
